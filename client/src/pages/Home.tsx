        ...
        <div className="container py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">الهاتف: <a href="https://wa.me/9660774706259" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition">0774 706 2599</a></p>
            </div>
          </div>
